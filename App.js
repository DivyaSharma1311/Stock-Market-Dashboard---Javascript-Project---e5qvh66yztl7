...
async function getData(type, stockName) {
  ...
  const APIKEY = "TZVJ1TCOFKDN4GHG";
  const URL = `https://www.alphavantage.co/query?function=TIME_SERIES_${type}&symbol=${stockName}&interval=5min&apikey=${APIKEY}`;
